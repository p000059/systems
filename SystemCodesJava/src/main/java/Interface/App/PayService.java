...
public class PayService {
    ...
    //Essa classe PayService tem uma dependência com o DeductionService mas não sabe qual será a implementação se, MG ou SP.
    private DeductionService deductionService;

    //Mas para saber qual a implementação se MG ou SP, é necessário um construtor recebendo um tipo de DeductionService, que pode ser SP ou MG.
    ...
    public double tax(double amount){
        ...
        //Ambas a classes MG e SP possuem o método deduction pois estas implementam a interface DeductionService,
