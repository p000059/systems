...
public class LambdaApplication {
	...
	public interface IGenericInterface<T> {
	    boolean test(T n, T m, T o);
	}

    public static void main(String[] args) {

        //region UnaryOperator
        //Essa interface herda da superinterface Function, que possui o método apply(Object) que recebe um parâmetro genérico e retorna o resultado.
        //UnaryOperator<Double> doubleUnaryOperator = n -> 98.5 - n; // Essa expressão também pode ser usada, pois recebe somente um parametro e uma expressão simples.
        ...
        //region Predicate
        //Esse predicate vai passar um argumento do tipo inteiro que vai ser avaliado se é impar ou par pela expressão lambda.
        Predicate<Integer> even = value -> value % 2 == 0;
        JOptionPane.showMessageDialog(null, "Valor do número: " + even.test(10));//O método teste vai receber o parãmetro inteiro.
        //endregion
        ...
        //Nesse exemplo a seguir a inteface funcional utiliza um argumento da interface na expessão lambda.
        ...
        iFunctionalMethodTwoParameter = (double n, double y) -> (n < y); //Essa referencia quanto ao tipo dos parametros, pode ser especificada ou não.
        ...
        iFunctionalMethodTwoParameter = (n, y) -> (n % y) == 0; // Nessa declaração de parametros, o tipo é compreendido por inferência.
        if(iFunctionalMethodTwoParameter.getValue(2.0, 10.0)){
