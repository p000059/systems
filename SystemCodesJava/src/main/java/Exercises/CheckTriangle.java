...
public class CheckTriangle {
	...
	public CheckTriangle(int angleOne, int angleTwo, int angleThree, int sideOne, int sideTwo, int sideThree) {
		super();
	...
	public static void main(String[] args) {
		...
		Boolean triangle = checkTriangle.checkIfTriangle(6, 7, 10);
		String result = checkTriangle.defineTheSides(5, 4, 3);

		JOptionPane.showMessageDialog(null, "Triângulo: " + triangle + "\nTriângulo: " + result);
	}
}
